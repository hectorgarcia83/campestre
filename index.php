...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav navbar-right" id="nav">
          ...
          <li><a href="#team">Amenidades</a></li>
          <li><a href="#services">Servicios</a></li>             
          <li><a href="#portfolio">Galeria</a></li>
          <li><a href="#pricing">Financiamientos</a></li>
  ...
  <footer>
    <div class="container">
      ...
      <!-- Copyright -->
      <p class="center grey">2015 &copy; All rights reserved. Powered by KamilaTI + SpirigaMKT</p>
      <!-- End Copyright -->
    </div>    
  </footer>
  <!-- End Footer -->
...
s1.async=true;
s1.src='https://embed.tawk.to/564ca29cc42b1eac50a8190c/default';
s1.charset='UTF-8';
