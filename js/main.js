$(document).ready(function(){
  ...
  //Google Maps
  function initMap() {
    var myLatlng = new google.maps.LatLng(24.8193335,-107.4752577); // <- Your latitude and longitude
    var markerPin = new google.maps.LatLng(24.820366,-107.489935); // <- Your latitude and longitude
